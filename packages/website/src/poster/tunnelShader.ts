...
// Dissolve into paper along x: no ink left of fadeStart, full print right of fadeEnd (fractions of width).
uniform vec2 fade;
...
void main() {
  ...
  if (fade.y > fade.x) field *= smoothstep(fade.x, fade.y, px.x / resolution.x);
