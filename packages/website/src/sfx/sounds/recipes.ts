/**
 * The sound palette — layer/recipe types, starter sounds and our own recipes.
...
export const RECIPES = {
  /** A small notification bell: a struck fundamental with two inharmonic partials that ring past it. */
  bell: {
    masterGain: 0.42,
    layers: [
      { kind: "tone", waveform: "sine", frequency: 1760, attack: 0.002, decay: 0.55, peak: 0.05 },
      { kind: "tone", waveform: "sine", frequency: 1760 * 2.76, attack: 0.001, decay: 0.28, peak: 0.018 },
      { kind: "tone", waveform: "sine", frequency: 1760 * 5.4, attack: 0.001, decay: 0.09, peak: 0.008 },
      { kind: "noise", filterType: "bandpass", filterFrequency: 5200, filterQ: 2.4, attack: 0.001, decay: 0.012, peak: 0.05 },
    ],
    shimmer: { delay: 0.09, feedback: 0.12, wet: 0.08, lowpass: 6000 },
  },
  /** A rounded, single-note confirmation at the signal family's upper octave. */
  complete: {
    masterGain: 0.4,
    layers: [
      { kind: "tone", waveform: "sine", frequency: 660, envelope: "smooth", attack: 0.008, decay: 0.11, peak: 0.035 },
    ],
  },
  /** A quiet air-only reverse swell, related to the travel swoosh. */
  rewind: {
    masterGain: 0.32,
    layers: [
      { kind: "noise", filterType: "lowpass", filterFrequency: 650, filterTo: 1800, filterTime: 0.65, filterQ: 0.6, envelope: "smooth", attack: 0.62, decay: 0.63, peak: 0.028 },
    ],
  },
  ...
  /** Red deletion: a short static burst with a falling, slightly buzzy blip and a dry crackle — a glyph being struck out. */
  erase: {
    masterGain: 0.42,
    layers: [
      { kind: "noise", filterType: "bandpass", filterFrequency: 2600, filterQ: 0.9, attack: 0.001, decay: 0.05, peak: 0.09 },
      { kind: "tone", waveform: "triangle", frequency: 640, glideTo: 170, glideTime: 0.1, attack: 0.002, decay: 0.11, peak: 0.05 },
      { kind: "noise", filterType: "highpass", filterFrequency: 5200, filterQ: 0.8, offset: 0.055, attack: 0.001, decay: 0.014, peak: 0.06 },
      { kind: "noise", filterType: "highpass", filterFrequency: 5200, filterQ: 0.8, offset: 0.092, attack: 0.001, decay: 0.01, peak: 0.04 },
    ],
  },
  /** Deletion alternatives to `erase`: chunkier, with no pitched glide blip. Each stays under .2s. */
  /** A low sine drop under a lowpassed puff — a soft, heavy thud. */
  eraseThump: {
    masterGain: 0.45,
    layers: [
      { kind: "tone", waveform: "sine", frequency: 110, glideTo: 65, glideTime: 0.09, attack: 0.003, decay: 0.09, peak: 0.09 },
      { kind: "noise", filterType: "lowpass", filterFrequency: 700, filterQ: 0.8, attack: 0.002, decay: 0.075, peak: 0.12 },
    ],
  },
  /** Three rapid, decaying lowpassed bursts over a low body — paper crumpling in the fist. */
  eraseCrunch: {
    masterGain: 0.45,
    layers: [
      { kind: "noise", filterType: "lowpass", filterFrequency: 1100, filterQ: 0.9, attack: 0.001, decay: 0.03, peak: 0.13 },
      { kind: "noise", filterType: "lowpass", filterFrequency: 1100, filterQ: 0.9, offset: 0.028, attack: 0.001, decay: 0.03, peak: 0.1 },
      { kind: "noise", filterType: "lowpass", filterFrequency: 1100, filterQ: 0.9, offset: 0.056, attack: 0.001, decay: 0.035, peak: 0.075 },
      { kind: "tone", waveform: "sine", frequency: 90, attack: 0.003, decay: 0.08, peak: 0.05 },
    ],
  },
  /** Dense midrange static with three high crackles and no tone — a signal being scrubbed out. */
  eraseStatic: {
    masterGain: 0.45,
    layers: [
      { kind: "noise", filterType: "bandpass", filterFrequency: 900, filterQ: 2, attack: 0.002, decay: 0.11, peak: 0.14 },
      { kind: "noise", filterType: "highpass", filterFrequency: 5200, filterQ: 0.8, offset: 0.02, attack: 0.001, decay: 0.008, peak: 0.05 },
      { kind: "noise", filterType: "highpass", filterFrequency: 5200, filterQ: 0.8, offset: 0.05, attack: 0.001, decay: 0.008, peak: 0.045 },
      { kind: "noise", filterType: "highpass", filterFrequency: 5200, filterQ: 0.8, offset: 0.085, attack: 0.001, decay: 0.008, peak: 0.04 },
    ],
  },
  /** The press knock with a fixed low triangle thud — a stamp coming down. */
  eraseStamp: {
    masterGain: 0.45,
    layers: [
      { kind: "noise", filterType: "bandpass", filterFrequency: 1700, filterQ: 1.4, attack: 0.001, decay: 0.02, peak: 0.13 },
      { kind: "tone", waveform: "triangle", frequency: 180, attack: 0.002, decay: 0.07, peak: 0.06 },
    ],
  },
  /** A lowpass sweep closing from 2400 to 500Hz over a low body — a strip torn away. */
  eraseTear: {
    masterGain: 0.45,
    layers: [
      { kind: "noise", filterType: "lowpass", filterFrequency: 2400, filterTo: 500, filterTime: 0.12, filterQ: 0.8, attack: 0.004, decay: 0.12, peak: 0.12 },
      { kind: "tone", waveform: "sine", frequency: 80, attack: 0.004, decay: 0.1, peak: 0.04 },
    ],
  },
  /** A quiet rising air whip with a low body — a pen shaft cast onto the page. */
  cast: {
    masterGain: 0.4,
    layers: [
      { kind: "noise", filterType: "bandpass", filterFrequency: 700, filterTo: 2400, filterTime: 0.11, filterQ: 0.9, attack: 0.03, decay: 0.12, peak: 0.06 },
      { kind: "tone", waveform: "sine", frequency: 150, glideTo: 320, glideTime: 0.11, attack: 0.02, decay: 0.09, peak: 0.02 },
    ],
  },
  /** The cast reversed and shorter: a falling air whip as the pen flicks off the page. */
  flick: {
    masterGain: 0.4,
    layers: [
      { kind: "noise", filterType: "bandpass", filterFrequency: 2600, filterTo: 600, filterTime: 0.08, filterQ: 0.9, attack: 0.012, decay: 0.08, peak: 0.06 },
    ],
  },
  /** A furious glare: two low sawtooths detuned to beat at 18 Hz (the eyes' twitch rate) over a sub body and a
   * narrow low growl of noise — a short, unfriendly tremolo, about .3 s. */
  glare: {
    masterGain: 0.42,
    layers: [
      { kind: "tone", waveform: "sawtooth", frequency: 92, attack: 0.02, decay: 0.27, peak: 0.03 },
      { kind: "tone", waveform: "sawtooth", frequency: 110, attack: 0.02, decay: 0.27, peak: 0.03 },
      { kind: "tone", waveform: "triangle", frequency: 55, attack: 0.03, decay: 0.28, peak: 0.05 },
      { kind: "noise", filterType: "bandpass", filterFrequency: 210, filterQ: 2.6, attack: 0.03, decay: 0.25, peak: 0.08 },
    ],
  },
